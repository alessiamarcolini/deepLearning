...
def main():
    ...
    np.savetxt("predicted_features_{}.txt".format(dataset), predicted_features)
    ...
    prediction_summary = open("retults/vgg16_first_train_raspberry_prediction_summary_{}.csv".format(dataset), "w")
