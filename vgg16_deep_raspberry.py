...
parser = MyArgumentParser(
    description='Deep Raspberry visualization with Keras of a pretrained VGG16.',
...
assert os.path.exists(weights_path), 'Model weights not found (see "weights_path" variable in script).'  # model.load_weights(weights_path)
...
file_list = np.loadtxt(image_file_list, dtype=str)
for base_image_path in file_list:
